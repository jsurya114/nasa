...
const DoubleStop = () => {
  ...
  const weeklyLoading = useSelector((state) => state.excel?.weekly?.loading);
  const dailyLoading = useSelector((state) => state.excel?.daily?.loading);
            ...
            >
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className={`px-6 py-2 rounded-lg shadow font-medium transition-all duration-200 flex items-center gap-2 ${
                    weeklyLoading
                ...
                >
                  ...
                  {weeklyLoading ? "Processing..." : "Upload Weekly Data"}
                </button>
              </div>
            </form>
          </section>
            ...
            >
              ...
              <div className="flex justify-end">
                ...
                >
                  ...
                  {dailyLoading ? "Processing..." : "Upload Daily Data"}
                </button>
              </div>
            </form>
          </section>
