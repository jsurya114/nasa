                      ...
                      <table className="w-full divide-y divide-gray-200">
                        <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                          <tr>
                            ...
                            <th className="px-3 lg:px-4 xl:px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider w-[25%]">
                              Address
                            </th>
                            <th className="px-3 lg:px-4 xl:px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider w-[25%]">
                              Access Code
                            </th>
                            <th className="px-3 lg:px-4 xl:px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider w-[8%]">
                              Images
                            </th>
                            <th className="px-3 lg:px-4 xl:px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider w-[20%]">
                              Created At
                            </th>
                            ...
                            >
                              ...
                              <td className="px-3 lg:px-4 xl:px-6 py-3">
                                <button
                                  ...
                                  className="inline-flex items-center justify-center px-3 py-2 bg-[#8200db] text-white text-xs font-medium rounded-lg hover:bg-[#7300c4] transition-all"
                                >
                                  <svg
