...
export default function DriverAvailability() {
  ...
  useEffect(() => {
    ...
    updateCurrentDay();
    const interval = setInterval(updateCurrentDay, 60000); // Check every minute
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
            <div className="flex items-start gap-2 sm:gap-3">
              ...
              <div className="flex-1">
                <p className="text-xs sm:text-sm font-semibold text-blue-900">Today is {getCurrentDayName()}</p>
                <p className="text-xs text-blue-700 mt-1">
                  You can update today and future days anytime. 
                  {getLockedDaysCount() > 0 && ` ${getLockedDaysCount()} past ${getLockedDaysCount() === 1 ? 'day is' : 'days are'} locked.`}
                </p>
              </div>
            </div>
          </div>
                        ...
                        >
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              <div className={`flex-shrink-0 h-10 w-10 rounded-lg flex items-center justify-center font-bold text-xs ${
                                isCurrentDay
                          ...
                          <td className="px-6 py-4 text-center">
                            {availability[key] ? (
                              <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold text-green-700 bg-green-100">
                              ...
                              <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold text-red-700 bg-red-100">
                                <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <td className="px-6 py-4 text-center">
                            <button
                              ...
                              disabled={isLocked}
                              title={isLocked ? `Cannot edit past days` : 'Toggle availability'}
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-xs sm:text-sm text-blue-800 space-y-1">
                      ...
                      <li>• <strong>You can update today and future days anytime</strong></li>
