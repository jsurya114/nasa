          ...
          <div className="p-8 text-gray-700 text-sm leading-relaxed space-y-6 bg-gray-50 border-b">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Please do not contact company management to complain about assigned routes or to express personal preferences regarding routes. Route assignments are made based on operational needs, and all drivers are expected to follow them as assigned.</li>
              </ul>
            </div>
