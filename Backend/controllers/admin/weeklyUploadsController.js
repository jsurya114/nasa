...
//     // Process Excel and insert data
//     const result = await processExcelFromBuffer(file.buffer, client);
...
// async function processExcelFromBuffer(buffer, client) {
//   // Read workbook
...
//       recordsInserted: aggregatedData.size
//     };
 ...
 * 
 * This version uses batched bulk inserts to avoid:
 * 1. PostgreSQL parameter limit (32,767 max)
 * 2. Huge query strings causing slowdown
 * 3. Memory issues with massive single queries
 * 
 * Performance: ~2-5 seconds for 10,000 records (instead of 52 seconds)
 */
...
async function processExcelFromBuffer(buffer, client, startTime) {
  ...
  // ========================================================================
  // STEP 2: Process rows and aggregate data
  // ========================================================================
